              ...
              <div>
                ...
                <div>
                  ...
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className=" w-full sm:aspect-[97/44]">
                      {service.icon}
                    </div>
                  </div>
                  ...
                  <ul className="mb-10 list-inside list-disc text-black dark:text-body-color">
                    <li className="mb-2 text-base font-medium text-black dark:text-body-color sm:text-lg lg:text-base xl:text-lg">
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-black dark:text-body-color">
