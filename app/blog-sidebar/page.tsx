...
return (
<>
  <section className="overflow-hidden pt-[180px] pb-[120px] bg-white">
    <div className="container">
      <div className="-mx-4 flex flex-wrap">
        <div className="w-full px-4 lg:w-8/12">
          <div>
            <h2
              className="mb-8 text-3xl font-extrabold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
              ¿Qué es SAGA?
            </h2>
            <div
              className="mb-10 flex flex-wrap items-center justify-between border-b border-black border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
              <div className="flex flex-wrap items-center">
                <div className="mr-10 mb-5 flex items-center">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-medium text-yellow">
                      Es un sistema de gestión documental conformada por una red articulada de procesos digitales basada
                      en Inteligencia Artificial que controla la gestión documental y los archivos de las Dependencias.
                    </h4>
                  </div>
                </div>
                {/* 
            ...
            <div>
              <p
                ...
                La entrada en vigor de la nueva Ley General de Archivos en 2019 establece como objetivos garantizar la
                organización, conservación, disponibilidad, integridad y localización
                expedita de los documentos de archivo pasa asi contribuir a la eficiencia y eficacia de la
                administración pública, la correcta gestión gubernamental y el avance institucional.
              </p>
              <p
                className="mb-10 text-base font-medium leading-relaxed text-black sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                Para lograrlo establece la implementación de un sistema integral de gestión
                de documentos electrónicos encaminado al establecimiento de gobiernos
                digitales y abiertos en el ámbito federal, estatal y municipal. Y de esta forma:
              </p>
              <ul
                className="list-outside list-square pl-12  mb-10 text-base font-medium leading-relaxed text-black sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                <li className="mb-5">
                  Favorecer la toma de decisiones, la investigación y el resguardo de la memoria documental.
                </li>
                <li className="mb-5">

                  Fomentar la cultura de la calidad en los archivos mediante la adopción de buenas prácticas nacionales
                  e internacionales.
                </li>
                <li className="mb-5">

                  Promover el uso y aprovechamiento de las tecnologías de la información para mejorar la administración
                  de los archivos por los sujetos obligados.
                  Favorecer la toma de decisiones, la investigación y el resguardo de la memoria documental.
                </li>
                <li className="mb-5">

                  Promover la difusión y divulgación del patrimonio documental de la Nación.
                </li>
              </ul>

              <div className="mb-10 w-full overflow-hidden rounded">
                <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                  <Image src="/images/blog/blog-details-01.jpg" alt="image" fill
              ...
              <p
                className="mb-10 text-base font-medium leading-relaxed text-black sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                Es un sistema de gestión documental conformada por una red articulada de procesos digitales basada en
              ...
              <div
                ...
                <p className="text-center text-base font-medium italic text-black">
                  SAGA fue desarrollado con código abierto, seguro, flexible y fácil de modificar. Lo cual garantiza la
                  continua mejora de procesos mediante la modelación y construcción de sistemas con innovadores legos
                  informáticos.
                </p>
              ...
              <p
                className="mb-10 text-base font-medium leading-relaxed text-black sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                El sistema SAGA es ya un referente para el cumplimiento de la normativa en cuestión de administración de
                archivos de todos los sujetos obligados a nivel nacional, y es de interés en el Archivo General de la
                Nación acercarles nuestra experiencia en este modelo para brindarles a los Sujetos Obligados de la LGA,
                una alternativa viable para migrar hacia la gestión automatizada de documentos electrónicos y así dar
                cumplimento a las obligaciones establecidas por el marco legal.
              </p>
              <p
                className="mb-10 text-base font-medium leading-relaxed text-black sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">

                En apoyo a todos los sujetos obligados por la LGA y en cumplimiento de lo definido por la Ley Federal de
                Austeridad Republicana, el Archivo General de la Nación ha considerado compartir de forma gratuita el
                licenciamiento perpetuo e ilimitado del sistema SAGA incluyendo su código fuente con lo que se
                garantizará la independencia tecnológica y autonomía de su institución tal y como se establece en el
        ...
        <div className="w-full px-4 lg:w-4/12">
          <div className="mt-12 mb-10 rounded-md bg-primary bg-opacity-5 p-6 dark:bg-opacity-5 lg:mt-0">
            <form className="flex items-center justify-between">
              <input type="text" placeholder="Search here..."
                className="palceholder-black mr-5 w-full rounded-md border border-transparent py-3 px-5 text-base font-medium text-black outline-none focus:border-primary dark:bg-white dark:bg-opacity-10" />
              <button
          ...
          <div className="mb-10 rounded-md bg-primary bg-opacity-5 dark:bg-opacity-10">
            <h3
              className="border-b border-black border-opacity-10 py-4 px-8 text-lg font-semibold text-black dark:border-white dark:border-opacity-10 dark:text-white">
              Related Posts
            </h3>
            <ul className="p-8">
              <li
                className="mb-6 border-b border-black border-opacity-10 pb-6 dark:border-white dark:border-opacity-10">
                <RelatedPost title="Best way to boost your online sales." image="/images/blog/post-01.jpg" slug="#"
                  date="12 Feb 2025" />
              </li>
              <li
                className="mb-6 border-b border-black border-opacity-10 pb-6 dark:border-white dark:border-opacity-10">
                <RelatedPost title="50 Best web design tips & tricks that will help you."
                  image="/images/blog/post-02.jpg" slug="#" date="15 Feb, 2024" />
              </li>
              <li>
                <RelatedPost title="The 8 best landing page builders, reviewed" image="/images/blog/post-03.jpg"
                  slug="#" date="05 Jun, 2024" />
              </li>
            </ul>
          </div>
          <div className="mb-10 rounded-md bg-primary bg-opacity-5 dark:bg-opacity-10">
            ...
            <ul className="py-6 px-8">
              <li>
                <a href="#0" className="mb-3 inline-block text-base font-medium text-black hover:text-primary">
                  Tailwind Templates
                </a>
              </li>
              <li>
