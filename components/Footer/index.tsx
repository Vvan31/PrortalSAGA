...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-primaryGreen dark:bg-blue  pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 mt-2 max-w-[360px] lg:mb-16">
                   <Image 
                   src='/images/logo/mexico.svg' 
                   alt="Gobierno de México" 
                   width={200}
                   height={100} />
   
                <p className="mb-9 mt-10 text-white font-medium leading-relaxed text-body-color">
